...
<form action="epassorders.php" method="post">
<fieldset>
<legend><strong>Event Pass Orders/Bookings</strong></legend>
<center>
<br>
<input type="submit" name="epassorders" value="SHOW ORDERS" style="background-color:#0abde3;" /> 
</label>
<br><br>
</form>
<?php
if(isset($_POST['epassorders']))
{
$query="SELECT * FROM `epassorders`"; 
$query_run=mysqli_query($con,$query);	
if(mysqli_num_rows($query_run)>0){
$result = mysqli_query($con,"SELECT * FROM epassorders");	
