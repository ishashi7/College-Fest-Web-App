...
<fieldset>
<legend><strong>Contacted Inbox Messages</strong></legend>
<center>
<br>
<input type="submit" name="inbox" value="SHOW INBOX" style="background-color:#0abde3;" /> 
</label>
<br><br>
</form>
<?php
...
$result = mysqli_query($con,"SELECT * FROM inbox");	
